...
def initialize(project):
    ...
    project.set_property('sonarqube_project_key', '{{ cookiecutter.project_slug }}')
    project.set_property('sonarqube_project_name', 'log {{ cookiecutter.project_slug }} model')
...
def set_unit_tests_properties(project):
    ...
    # Default - []
    project.set_property('coverage_exceptions', ['__init__','api.config', 'api.constants'])
